...
public class MainFrame extends JFrame {
    ...
    private JLabel labelNivel = new JLabel("Nivel Selecionado");
    ...
    public void buttonInitialState_ActionPerformed(ActionEvent e) {
        //labelNivel will get the name of the file chosen by the user
